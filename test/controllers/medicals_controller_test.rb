...
class MedicalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical" do
    assert_difference('Medical.count') do
      post medicals_url, params: { medical: { description: @medical.description, name: @medical.name } }
    end
  ...
  test "should update medical" do
    patch medical_url(@medical), params: { medical: { description: @medical.description, name: @medical.name } }
